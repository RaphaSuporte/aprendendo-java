...
public class Funcionario {
    ...
    Funcionario funcionario1 = new Exercicio1.Funcionario ();
    Funcionario funcionario2 = new Exercicio1.Funcionario ();
    Funcionario funcionario3 = new Exercicio1.Funcionario ();
